...
cate = 'laptop'
DIR_BASE='global_results_full/ssd_'+cate+'_skew_clean'  # savedir base
...
def main():
    ...
    for eps in [0.5]:
        ...
        plt.axis("off")
        # acc_loss1 = [acc_loss1[0]*1.2] + acc_loss1
        # acc_loss2 = [acc_loss2[0]*1.1] + acc_loss2
        # fig, ax1 = plt.subplots()
        # ax2 = ax1.twinx()
        # lns1=ax1.axhline(y=original_loss_history['bbox_regression'], color='r', linestyle='dashed', label='Orig Regression')
        # lns2=ax2.axhline(y=original_loss_history['classification'], color='b', linestyle='dashed', label='Orig Classfication')    
        # lns3=ax1.plot(acc_loss1, color='r', label='Patch Regression')
        # lns4=ax2.plot(acc_loss2, color='b', label='Patch Classification')
        # ax1.set_xlabel('Epoch', fontsize=24)
        # ax1.set_ylabel('Regression Loss', color='r', fontsize=20)
        # ax2.set_ylabel('Classfication Loss', color='b', fontsize=20)
        # h1, l1 = ax1.get_legend_handles_labels()
        # h2, l2 = ax2.get_legend_handles_labels()
        # ax1.legend(h1+h2, l1+l2, loc=0, fontsize=14)
        # ax1.legend()
        # ax2.legend(loc=0)
        # plt.savefig("ssd_curve_person0.5.png")
