...
cate = 'laptop'
DIR_BASE='frcnn_cross_double'  # savedir base
...
def main():
    ...
    for eps in [0.5]:
        ...
        for j in range(test_images.shape[0]):
            ...
            # clean change 2
            x_tmp = np.transpose(test_pert_images[j:j+1], (0,2,3,1))
            ...
            patch_predictions = ssd.predict(np.transpose(patched_images, (0,2,3,1)))
            try:
