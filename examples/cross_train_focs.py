...
cocoCLS=CLS
cate = 'laptop'
DIR_BASE='cross_focs_ssd'  # savedir base
...
def main():
    ...
    for eps in [0.5]:
        ...
        # patch = np.load("global_results_full/ssd_"+cate+"_cross_double0.5/patch_{}.npy".format(eps))
        ...
        for j in range(test_images.shape[0]):
            ...
            results = yolo5(torch.Tensor(test_images[j:j+1])/255.)[0]
            pert_predictions = {}
